...
def main() -> None:
    ...
    parser.add_argument("--ngspice-official", default=os.environ.get("NGSPICE_OFFICIAL_BIN", "ngspice"))
    parser.add_argument("--ngspice-optimized", default=os.environ.get("NGSPICE_OPTIMIZED_BIN", "upstream/ngspice_for_sizing/build/src/ngspice"))
